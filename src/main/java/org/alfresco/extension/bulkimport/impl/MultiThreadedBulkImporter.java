 ...
 */
public abstract class MultiThreadedBulkImporter
    extends AbstractBulkImporter
{
    private final static Log log = LogFactory.getLog(MultiThreadedBulkImporter.class);
    ...
    public MultiThreadedBulkImporter(final ServiceRegistry       serviceRegistry,
    ...
    /**
     * @see org.alfresco.extension.bulkimport.impl.AbstractBulkImporter#bulkImportImpl(org.alfresco.service.cmr.repository.NodeRef, java.io.File, boolean, boolean)
     */
    @Override
