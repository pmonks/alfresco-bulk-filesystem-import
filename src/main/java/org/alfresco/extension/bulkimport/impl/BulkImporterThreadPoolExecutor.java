 ...
 */
public class BulkImporterThreadPoolExecutor
    extends ThreadPoolExecutor
{
    private final static Log log = LogFactory.getLog(BulkImporterThreadPoolExecutor.class);
    ...
    public BulkImporterThreadPoolExecutor()
    {
    ...
    public BulkImporterThreadPoolExecutor(final int corePoolSize, final int maximumPoolSize)
    {
        this(corePoolSize, maximumPoolSize, DEFAULT_KEEP_ALIVE_TIME, DEFAULT_KEEP_ALIVE_TIME_UNIT, DEFAULT_BLOCKING_QUEUE_SIZE);
    }
    
    public BulkImporterThreadPoolExecutor(final int      corePoolSize,
