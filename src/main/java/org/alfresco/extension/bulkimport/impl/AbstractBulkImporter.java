 ...
 */
public abstract class AbstractBulkImporter
    implements BulkImporter
{
    private final static Log log = LogFactory.getLog(AbstractBulkImporter.class);
    ...
    protected AbstractBulkImporter(final ServiceRegistry       serviceRegistry,
    ...
    /**
     * @see org.alfresco.extension.bulkimport.BulkImporter#bulkImport(java.io.File, org.alfresco.service.cmr.repository.NodeRef, boolean)
     */
