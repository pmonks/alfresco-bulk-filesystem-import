...
echo WARNING: it also doesn't create the full set of test data files, due to the
echo          serious limitations of the NTFS filesystem.
...
mkdir Unicode\Chinese_孔子

echo Creating test files with punctuation characters in their names...
echo WARNING: this may fail as NTFS is stricter about illegal filename characters
echo          than Alfresco.
mkdir Punctuation
mkdir Punctuation\Valid
...
rem mkdir Punctuation\Invalid
rem echo This file has the backslash \ character in its name.  It is probable that users on Windows systems will be unable to check this file out of SVN. > Punctuation\Invalid\back\\slash.txt
rem echo This file has the double quote " character in its name. > Punctuation\Invalid\double"quote"character.txt
